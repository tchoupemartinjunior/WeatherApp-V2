var app = new Vue({
    ...
    methods: {
        ...
        init(){
           ...
           var url ="https://api.weatherapi.com/v1/current.json?key=fa3298ecc65740a5bb981803220802&q=Yaounde&aqi=no";
           axios.get(url)
                .then(function (response) {
                       ...
                       console.log(app.weather.current);
                        console.log(app.weather.location);
                    }
